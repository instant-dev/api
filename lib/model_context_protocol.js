  ...
  endpoints: {
    'server.mcp': {
      ...
      'tools/call': async (definitions, mcpRequest, data, port, headers) => {
        ...
        if (data.mcp_authorization_header || headers['authorization']) {
          useHeaders['authorization'] = data.mcp_authorization_header || headers['authorization'];
        }
      ...
      'resources/templates/list': (definitions, mcpRequest) => {
        const resourceTemplates = [
          {
            uriTemplate: "file://{path}",
            name: 'Package files',
            description: 'Files in this package',
