...
class Gateway extends EventEmitter {
  ...
  async __requestHandler__ (req, res, definition, data, functionArgs, headers) {
    ...
    await this.execute(definition, functionArgs, data, headers, (err, value, headers, executionUuid) => {
  ...
  async execute (definition, functionArgs, data, headers, callback) {
    headers = headers || {};
    let fn;
    let complete = false;
